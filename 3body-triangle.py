...
p2 = np.array([-0.5, 0.86602540378, 0.0])
p3 = np.array([-0.5, -0.86602540378, 0.0])

# 초기 속도
v1 = np.array([0.0, 0.759835686, 0.0])
v2 = np.array([-0.658, -0.3799, 0.0])
v3 = np.array([0.658, -0.3799, 0.0])

# 전체 초기 조건 벡터 (위치와 속도를 일렬로 배열)
